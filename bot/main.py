...
class Moderation(commands.Cog):
    ...
    async def _mute(self, ctx, member: discord.Member):
        ...
        embed = discord.Embed(title=f"{version} Mute", url="https://github.com/Mistyttm/DiscordQUTVerificationBot",
                              description=f"Muted-{member.mention}", colour=discord.Colour.dark_blue())
    ...
    async def _unmute(self, ctx, member: discord.Member):
        ...
        embed = discord.Embed(title=f"{version} Unmute", url="https://github.com/Mistyttm/DiscordQUTVerificationBot",
                              description=f"Un-muted-{member.mention}", colour=discord.Colour.dark_blue())
        await ctx.send(embed=embed)
...
class Verification(commands.Cog):
    ...
    async def _info(self, ctx):
        embed = discord.Embed(title="Verification Instructions", url="https://github.com/Mistyttm/DiscordQUTVerificationBot",
...
class Info(commands.Cog):
    ...
    async def _info(self, ctx):
        global version
        embed = discord.Embed(title=f"{version}", url="https://github.com/Mistyttm/DiscordQUTVerificationBot",
                              description=f"This bot was designed and programmed by *Emmey Leo* for the QUT IN01 Discord. It provides a system to verify that new members are qut students. This project is completely open source and any and all people are allowed to contribute to the github:\n\n**https://github.com/Mistyttm/DiscordQUTVerificationBot**", color=discord.Color.dark_blue())
        embed.set_thumbnail(
    ...
    async def _changelog(self, ctx):
        ...
        embed = discord.Embed(title=f"{version} Changelog", url="https://github.com/Mistyttm/DiscordQUTVerificationBot",
                              description=f"{changelog}", color=discord.Color.dark_blue())
        embed.set_thumbnail(
            url="https://media.discordapp.net/attachments/943355996934402119/954311293249138708/qut-bot-logo.png?width=663&height=663")
        embed.set_author(
    ...
    async def _bug(self, ctx):
        embed = discord.Embed(title=f"{version} Issue report", url="https://github.com/Mistyttm/DiscordQUTVerificationBot",
                              description=f"Please go to this site and fill out a bug report:\n\nhttps://github.com/Mistyttm/DiscordQUTVerificationBot/issues/new/choose", color=discord.Color.red())
        await ctx.send(embed=embed)
    ...
    async def _hiq(self, ctx):
        embed = discord.Embed(title=f"{version} HiQ", url="https://github.com/Mistyttm/DiscordQUTVerificationBot",
    ...
    async def _hiq(self, ctx):
        embed = discord.Embed(title=f"{version} Tone Tags", url="https://github.com/Mistyttm/DiscordQUTVerificationBot",
...
if __name__ == "__main__":
    run()
>>>>>>> c2da0930cb0bfaa371b7ff316f98c779ba0b82ef
